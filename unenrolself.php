...
/**
 * Braintree enrolment plugin - support for user self unenrolment.
 *
...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'braintree'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/braintree/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_braintree', format_string($course->fullname));
